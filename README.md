[![Static Badge](https://img.shields.io/badge/version-1.1.0-green)](https://github.com/zukaitis/investment-tracker/releases/tag/1.1.0)
...
3. Add files containing information about your assets to the root of your repository - one file per asset. Examples of the input format can be found in [`examples`](https://github.com/zukaitis/investment-tracker/tree/release/examples) directory
